...
<div id="page-wrapper" style="min-height: 292px;">
   ...
   */
            ...
            if (isset($_GET['id_solde_rest']) && isset($_POST['id_carte_sim']) && isset($_POST['sr_data']) && isset($_POST['sr_sms']) && isset($_POST['sr_minute']) && isset($_POST['sr_credit']) && isset($_POST['dates'])) {
                $sql = " UPDATE  Solde_restant SET sr_data = . '$data_restant' . ,sr_sms= . '$sms_restant' . ,sr_minute= . '$minute_restante' . ,sr_credit= . '$credit_restant' . , created_at= . '$dates' .  WHERE  (id_solde_rest = . '$id_solde_rest' .) ";
